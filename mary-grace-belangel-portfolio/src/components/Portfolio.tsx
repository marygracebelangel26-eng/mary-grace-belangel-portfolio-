...
export default function Portfolio() {
  const [activeFilter, setActiveFilter] = useState<'All' | 'Instagram' | 'Facebook' | 'Reels/Video' | 'Promotional'>('All');
    ...
    <section id="portfolio" className="py-24 bg-[#0A0A0A] border-t border-[#262626] relative">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-wrap gap-2.5 mb-10 pb-2 border-b border-[#262626]">
          {(['All', 'Instagram', 'Facebook', 'Reels/Video', 'Promotional'] as const).map((filter) => (
            <button
              key={filter}
              ...
              <div className="px-4 py-3 bg-[#131313] border-b border-[#262626] flex items-center justify-between z-10">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-[#F5F5F5] leading-none">marygrace.smm</span>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-[8px] text-[#9CA3AF] font-mono capitalize">
                    {item.platform === 'meta' ? 'Meta Ads' : item.platform}
                  </span>
                </div>
              </div>

              {/* Graphic Representation Area (Simulated Template Asset) */}
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0A0A0A]/95 backdrop-blur-lg">
          ...
          <div className="relative w-full max-w-4xl bg-[#1A1A1A] border border-[#262626] rounded-2xl overflow-hidden shadow-2xl z-10 grid grid-cols-1 md:grid-cols-12 max-h-[90vh] md:max-h-[80vh]">
            ...
            <div className={`col-span-12 md:col-span-6 bg-gradient-to-b ${selectedItem.visualStyle.gradient} relative flex flex-col items-center justify-center p-8 text-center min-h-[300px] md:min-h-full border-b md:border-b-0 md:border-r border-[#262626]`}>
                ...
                <div className="flex items-center space-x-3.5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-[#F5F5F5] capitalize">
                      {selectedItem.platform === 'meta' ? 'Meta Ad Manager Campaign' : selectedItem.platform}
                    </span>
                  </div>
                </div>
