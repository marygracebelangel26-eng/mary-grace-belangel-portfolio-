...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    filter: 'carousel-post',
    caption: 'A 5-slide Instagram carousel designed to maintain reader engagement and attention, educating the audience on therapy dogs while building emotional connection — created for Therapy Dogs NSW.',
  ...
  },
  {
    ...
    category: 'Carousel Post',
    filter: 'carousel-post',
    caption: 'A high-converting 5-slide Instagram carousel designed to maintain reader engagement, stop the scroll with an high-intensity action hook, educate on benefits, provide social proof, and drive new sign-ups for REVFIT gym.',
    metrics: 'Featured Project',
    accentColor: '#5CC4EE',
    visualStyle: {
      gradient: 'from-[#121212] via-[#5CC4EE]/10 to-[#121212]',
